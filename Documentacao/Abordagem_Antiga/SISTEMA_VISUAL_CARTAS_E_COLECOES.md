> **Status: Abordagem Antiga**
>
> Este documento registra a estrutura conceitual utilizada durante a fase inicial de desenvolvimento do projeto Nível 1.
>
> A estrutura descrita neste documento não representa necessariamente a organização atualmente utilizada para produção e distribuição das cartas.
>
> A abordagem atual é incremental e orientada pelas necessidades dos jogadores e personagens em jogo. Consulte o `README.md` para a abordagem vigente.
>
> Este documento é mantido como registro histórico das decisões e conceitos desenvolvidos anteriormente e poderá ser consultado ou reaproveitado quando necessário.
